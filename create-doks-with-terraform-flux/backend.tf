...
terraform {
  backend "s3" {
    ...
    region                      = "eu-north-1"                        # leave this as is (Terraform expects the AWS format - N/A for DO Spaces)
    bucket                      = "template-pet-backet0pilgrim"                    # replace this with your bucket name
